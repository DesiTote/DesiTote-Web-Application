...
export async function fetchAdminCustomerList(query) {
 ...
 * ──────────────────────────────────────────────────────────── */
export async function setCustomerBlockedStatus(userId, blocked) {
    ...
    const user = await User.findByIdAndUpdate(userId, { isAccountBlocked: blocked }, { new: true }).select("fullName email role isAccountBlocked");
    return user;
}
//# sourceMappingURL=customer.admin.service.js.map