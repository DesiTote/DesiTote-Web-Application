 ...
 * ──────────────────────────────────────────────────────────── */
export async function checkReviewEligibility(userId, productId) {
    ...
    return { eligible: true, orderId: deliveredOrder._id.toString() };
}
...
export async function createReview(input) {
    ...
    if (!eligibility.eligible) {
        throw new ApiError(403, eligibility.reason === "already_reviewed"
 ...
 * ──────────────────────────────────────────────────────────── */
export async function getReviewableOrderItems(orderId, userId) {
